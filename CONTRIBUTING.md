...
焼津市は、公開しているオープンデータやソフトウェアを改善するご提案、要望を歓迎します。データの間違いを指摘・修正したり、ソフトウェアの修正や改善要望をする方法をご説明します。
...
↓ 1. ファイルの選択
![ファイルの選択](docs/images/contributing/select-file.png)

↓ 2. ファイルを編集する
![ファイルを編集する](docs/images/contributing/edit-file.png)

↓ 3. 修正内容を登録する
![ファイルを更新する](docs/images/contributing/commit-file.png)
