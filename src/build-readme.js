...
class BuildReadme {
  run() {
    ...
    readme += "## ▼データ貢献方法（更新リクエスト）\n\n";
    readme += "掲載データの誤り・追加・更新などについて、リクエストを送ることができます。\n";
    readme += "リクエストを希望するデータの編集済みデータをプルリクエストとして送ってください。\n";
    readme += "焼津市で確認の上、反映を検討いたします。詳しくは [焼津市オープンデータ貢献方法](CONTRIBUTING.md) を参照してください。\n\n";
