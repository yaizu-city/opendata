...
let locationDataCategories = [];
if (fs.existsSync('./location-data-categories.json')) {
  locationDataCategories = require('./location-data-categories.json');
}

let standardDataCategories = [];
if (fs.existsSync('./standard-data-categories.json')) {
  standardDataCategories = require('./standard-data-categories.json');
}
